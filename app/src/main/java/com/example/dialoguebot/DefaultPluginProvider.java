...
import com.example.dialoguebot.devicectrl.DeviceAbilityImpl;
import com.example.dialoguebot.player.AudioTrackPlayer;
import com.example.dialoguebot.util.FileUtils;
...
public class DefaultPluginProvider implements IPluginProvider {
   ...
   public IAlertAbility getAlertAbility() {
        return null;//new AlertAbilityImp(mContext);
    }
